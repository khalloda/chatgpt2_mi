...
use function App.Core\csrf_field; // if your namespace uses backslash, adjust
...
<section>
  ...
  <table style="width:100%;border-collapse:collapse;">
    ...
    <tbody>
        ...
        <tr>
          ...
          <td style="padding:8px;border-bottom:1px solid #f2f2f4;">
            <form method="post" action="<?= base_url('/payments/delete') ?>" onsubmit="return confirm('Delete payment?')">
              ...
              <input type="hidden" name="_return" value="<?= base_url('/invoices/show?id='.(int)$i['id']) ?>">
      ...
      <?php endforeach; ?>
      <?php if (!$payments): ?><tr><td colspan="5" style="padding:8px;">No payments yet.</td></tr><?php endif; ?>
    </tbody>
  </table>
